<?php
/**
 * views/recruiter/complaints.php
 */
...
// Fetch complaints submitted by this recruiter
...
<div class="container">
    ...
    <div style="background: #fff3cd; padding: 15px; border-radius: 5px; margin-bottom: 30px; border: 1px solid #ffeeba;">
        <p style="margin: 0; color: #856404;">If you've encountered abusive conduct from a Job Seeker or Client, please report it here for Admin investigation.</p>
        
        <form method="POST" action="complaints.php" style="margin-top: 15px;">
            <input type="hidden" name="action" value="submit">
            
            <div class="form-group">
                <label>Subject ID (Optional - Seeker ID or Employer ID)</label>
