...
<head>
    ...
    <style>
        ...
        .msg-sent { background-color: #35424a; color: white; float: right; border-bottom-right-radius: 0; }
        ...
        .message-form button { padding: 10px 20px; background: #e8491d; color: white; border: none; border-radius: 4px; margin-left: 10px; cursor: pointer; }
    ...
    <div class="chat-area">
        <?php if ($activeContactId): ?>
            ...
            <form class="message-form" method="POST" action="messages.php">
                ...
                <input type="text" name="body" placeholder="Type a message (e.g. Interview invitation)..." required autocomplete="off">
                <button type="submit">Send</button>
            </form>
        <?php else: ?>
            <div style="display: flex; align-items: center; justify-content: center; height: 100%; color: #888;">
                <p>Select an applicant to message</p>
            </div>
        <?php endif; ?>
    </div>
</div>
